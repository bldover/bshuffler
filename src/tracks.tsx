import {minTrackDurationMs} from "./settingsHandler"
...
export async function getAlbumTracks(uri: string) {
    ...
    let urisWithArtists: UriWithArtist[] = albumResponse.tracks.items
        .filter(item => item.track.playability.playable && item.track.duration.totalMilliseconds >= minTrackDurationMs)
